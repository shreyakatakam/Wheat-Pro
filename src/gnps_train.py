...
def train_model(file_path):
    ...
    pooled_file_path = 'models/GNPS_Pooled_model.joblib'
    ...
    joblib.dump(expected_columns.tolist(), 'models/GNPS_Pooled_columns.joblib')

    # Save the model
    model_file_path = 'models/GNPS_Pooled_model.joblib'
    joblib.dump(model, model_file_path)

    # Print the paths for confirmation
    print(f"Columns used during training saved to: models/GNPS_Pooled_columns.joblib")
